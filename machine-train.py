...
def read_training_data(training_directory):
    ...
    for each_letter in letters:
        for each in range(10):
            ...
            # the 2D array of each image is flattened bc machine learning classifier requires each samoke is 1D array
            # therfore the 20 by 20 img becomes 1 by 400
...
def cross_validation(model, num_of_fold, train_data, train_label):
    ...
    # the num_of_fold determines type of validation
    # ex: if num_of_fold is 4, then we are doing a 4-fold cross validation
    # it divides data set into 4 and use 1/4 of it for testing and remaining 3/4 for training
...
# predict, we dont need to train the model again
